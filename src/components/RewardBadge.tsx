...
export function RewardBadge({ 
  ...
  const content = (
    <Badge className={`gap-2 pr-2 pl-3 h-9 bg-gradient-to-r ${color} text-white border-0 hover:opacity-90`}>
      <div className={`${container} rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center`}>
        <Icon className={icon} />
      </div>
      <span className={text}>
