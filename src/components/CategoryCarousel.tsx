        ...
        {categories.map((category, index) => {
          ...
          return (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`flex-shrink-0 snap-start flex flex-col items-center justify-center gap-3 ${category.bgColor} rounded-2xl p-6 min-w-[140px] h-[140px] md:min-w-[160px] md:h-[160px] border-2 border-transparent hover:border-white shadow-md hover:shadow-lg transition-all duration-300`}
            >
