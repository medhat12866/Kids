      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-[#FF6B9D] to-[#9C6FFF] flex items-center justify-center">
              ...
              return (
                <Button
                  ...
                  className={`h-11 px-6 rounded-full ${
                    isActive
                      ? "bg-linear-to-r from-[#FF6B9D] to-[#9C6FFF] text-white hover:opacity-90"
                      : ""
                  }`}
                >
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <div className="w-9 h-9 rounded-full bg-linear-to-br from-[#FFB84D] to-[#FF8B67] flex items-center justify-center text-white">
